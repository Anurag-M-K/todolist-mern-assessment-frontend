...
function Navbar() {
  ...
  return (
    <div className={`box flex justify-between items-center w-full p-4 m-3 bg-blue-700  ${userDetails.username==import.meta.env.VITE_APP_NAME ? "bg-opacity-60":""} shadow-lg text-white`}>
